...
class UpdateCard extends Component {
  ...
  handleSubmit() {
    ...
    FlashcardDataService.updateCard(card).then(this.props.history.push(`/manageCards`))
  }
                ...
                <div className="container">
                    <form onSubmit={this.handleSubmit}>
                      ...
                      <FormGroup controlId ="answer">
                        ...
                        <br/><br/>
                      <button className="btn btn-success" type="submit" disabled={this.state.isValid}>Update</button>&ensp;
